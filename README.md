...
### 国际化应该怎么处理
#### Q:在什么地方定义国际化状态码 
A:应该在app/pkg/e/code.go文件中定义状态码，可以看见的是，目前该文件中已经定义好了一些基础的状态码，-1~1000为基础的状态码，10001~10999为服务端状态码，11000~11050为授权状态码。新定义的状态码应该以1000为一个区间，在已经定义的状态码后面增加。定义的状态码常量应该尽量短，且意思明确。
#### Q:在什么地方定义国际化语言
